...
module.exports = function (data, config = {}) {
    ...
    result.geo = {
        ...
        emphasis: {
            itemStyle: {
                areaColor: 'rgba(255, 152, 0, 0.5)', // More visible orange
                borderColor: '#ff9800',
                borderWidth: 1
            },
            label: {
    ...
    result.series = [
        {
            ...
            itemStyle: { color: config.color || '#ff5722', opacity: 0.9 }
        },
        {
            name: 'Highlights',
            type: 'effectScatter',
            coordinateSystem: 'geo',
            data: effectPoints,
            symbolSize: (config.symbolSize || 6) * 1.2,
            showEffectOn: 'render',
            rippleEffect: { brushType: 'stroke', scale: 3, period: 4 },
            itemStyle: { color: config.color || '#ff5722', shadowBlur: 5 }
        }
    ];
