...
const { resolveWithRoot } = require('./utils/path_resolver');
...
<script>
(${this.getRuntimeCode.toString()})(${mapDataPathsJson});
</script>`;
    }
    ...
    /**
     * Get the runtime code as a function (will be stringified)
     * This runs in the browser, not Node.js
     * @param {object} mapDataPaths
     */
    getRuntimeCode(mapDataPaths) {
